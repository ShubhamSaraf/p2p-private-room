/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 6815c31539787519b1d3ced3822059c8)
// Runtime types generated with workerd@1.20260811.1 2026-08-15 nodejs_compat
interface __BaseEnv_Env {
	PUBLIC_API_RATE_LIMITER: RateLimit;
	APP_ORIGIN: "https://peerlink.shubhamsaraf.dev";
	APP_PREVIEW_ORIGIN: "https://peerlink-387.pages.dev";
	TURN_HOST: "turn.shubhamsaraf.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "APP_PREVIEW_ORIGIN" | "TURN_HOST" | "TURN_CREDENTIAL_TTL_SECONDS">> {}
}
